 ...
 * Complete list of all 873 exercise image folders from Supabase storage
...
export const AVAILABLE_SUPABASE_FOLDERS = [
  ...
  'close-grip-e-z-bar-curl-with-band',
  ...
  'hack-squat',
  'hammer-curls',
  'hammer-grip-incline-d-b-bench-press',
  'hamstring-s-m-r',
  'hamstring-stretch',
  'handstand-push-ups',
  'hang-clean',
  ...
  'i-t-band-and-glute-stretch',
  'iliotibial-tract-s-m-r',
  'inchworm',
